...
function calculateInvoice() {
    ...
    // Show the invoice and proceed to checkout
    alert(`Proceeding to Checkout. Total: $${total.toFixed(2)} JMD`);

    // Store the total in localStorage for the invoice page (if needed)
    localStorage.setItem('invoiceTotal', total);

    // Redirect to the invoice page
    window.location.href = 'invoice.html';  // Change to your actual invoice page URL
}
